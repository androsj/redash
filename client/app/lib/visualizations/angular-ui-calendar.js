...
function uiCalendarOptions() {
  return {
    ...
    // Custom text for view toggle buttons
    views: {
...
function uiCalendarCtrl($scope, $locale) {
...
function uiCalendar(uiCalendarConfig) {
  return {
    restrict: 'A',
    scope: {
...
const angularUICalendar = angular.module('ui.calendar', [])
  .constant('uiCalendarConfig', uiCalendarConfig)
  .factory('uiCalendarOptions', uiCalendarOptions)
  .controller('uiCalendarCtrl', uiCalendarCtrl)
  .directive('uiCalendar', uiCalendar);

export default angularUICalendar;
